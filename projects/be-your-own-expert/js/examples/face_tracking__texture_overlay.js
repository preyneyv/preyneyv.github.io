...
const _textures = [
  {
    ...
    tex:        faceTextures.BR.tex, // or faceTextures.marcel.tex

    // Array of Numbers between 0.0 and 1.0, [x, y, x, y, ..., x, y],
    // with either 68 * 2 or 74 * 2 length.
    uv:         faceTextures.BR.uv, // or faceTextures.marcel.uv
...
export const select = (key) => {
  _textures[0].tex = faceTextures[key].tex;
  _textures[0].uv = faceTextures[key].uv;
  run(1);
}
